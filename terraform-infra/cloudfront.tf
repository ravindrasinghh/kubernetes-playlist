module "ui-cf" {
  ...
  viewer_certificate = {
    cloudfront_default_certificate = local.ui_conf.cloudfront_default_certificate
    acm_certificate_arn            = module.acm_cf.acm_certificate_arn
    ssl_support_method             = local.ui_conf.ssl_support_method
    minimum_protocol_version       = local.ui_conf.minimum_protocol_version
  }
